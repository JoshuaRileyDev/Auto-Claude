...
export const createProjectAPI = (): ProjectAPI => ({
  ...
  checkoutGitBranch: (projectPath: string, branch: string): Promise<IPCResult<{ branch: string; stashCreated?: boolean }>> =>
  ...
  createGitBranch: (
    ...
    newBranch: string,
    fromBranch?: string
  ): Promise<IPCResult<{ branch: string; stashCreated?: boolean }>> =>
